...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20260815122908_ReworkPeopleAndMerges")]
    partial class ReworkPeopleAndMerges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Friendship.Friendship", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Domain.Models.PlayerMerge.PlayerMergeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Friendship.Friendship", b =>
                {
                    b.OwnsOne("Domain.Models.User.UserId", "AddresseeId", b1 =>
                        {
                    ...
                    b.OwnsOne("Domain.Models.User.UserId", "RequesterId", b1 =>
                        {
                            b1.Property<Guid>("FriendshipId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Models.Game.Game", b =>
                {
                    ...
                    b.OwnsOne("Domain.Models.Game.DifficultyModifier", "DifficultyModifier", b1 =>
                        {
                            b1.Property<Guid>("GameId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Domain.Models.Game.PlayedScenario", "Scenario", b1 =>
                        {
                            ...
                            b1.OwnsOne("Domain.Models.Game.PlayedScenarioId", "Id", b2 =>
                                {
            ...
            modelBuilder.Entity("Domain.Models.PlayerMerge.PlayerMergeRequest", b =>
                {
                    b.OwnsOne("Domain.Models.Player.PlayerId", "PlayerId", b1 =>
                        {
                            b1.Property<Guid>("PlayerMergeRequestId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("PlayerMergeRequestId");

                            b1.HasIndex("Value");

                            b1.ToTable("PlayerMergeRequests");

                            b1.WithOwner()
                                .HasForeignKey("PlayerMergeRequestId");
                        });
                    ...
                    b.OwnsOne("Domain.Models.User.UserId", "TargetUserId", b1 =>
                        {
                            b1.Property<Guid>("PlayerMergeRequestId")
                                .HasColumnType("uniqueidentifier");
